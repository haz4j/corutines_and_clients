...
// */
//public final class KtorApacheHttpClient implements Client {
//    private static final String ACCEPT_HEADER_NAME = "Accept";
//
//    private final HttpClient client;
//
//    public KtorApacheHttpClient(HttpClient client) {
//        this.client = client;
//    }
//
//    @Override
//    public Response execute(Request request, Request.Options options) throws IOException {
//        HttpRequestBuilder httpUriRequest;
//        try {
...
//        BuildersKt.get()
//
//        HttpClientCall httpClientCall = client.execute(httpUriRequest);
////        io.ktor.client.response.HttpResponse response = httpClientCall.getResponse();
////        return toFeignResponse(httpClientCall, request);
//    }
//
//    HttpRequestBuilder toHttpUriRequest(Request request, Request.Options options)
